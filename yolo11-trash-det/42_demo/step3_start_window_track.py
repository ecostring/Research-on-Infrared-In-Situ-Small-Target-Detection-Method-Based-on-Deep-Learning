...
WELCOME_SENTENCE = "欢迎使用基于yolo11的红外空中目标检测系统"   # 欢迎的句子
ICON_IMAGE = "images/UI/lufei.png"                 # 系统logo界面
IMAGE_LEFT_INIT = "images/UI/222.jpeg"              # 图片检测界面初始化左侧图像
IMAGE_RIGHT_INIT = "images/UI/333.jpeg"          # 图片检测界面初始化右侧图像
...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        # self.init_vid_id = 'http://192.168.1.100:8080/video'  # 网络摄像头修改 包括ip或者是ip地址的修改
        # self.vid_source = int(self.init_vid_id)  # 需要设置为对应的整数，加载的才是usb的摄像头
        ...
        self.model_path = r"D:\桌面\毕业设计\model\Air_detect\CG-yolo11\weights\best.pt"  # todo 指明模型加载的位置的设备
    ...
    def initUI(self):
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/222.jpeg"))
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/111.jpeg'))
...
class LoginWindow(QWidget):
    def __init__(self, parent=None):
        ...
        a = QLabel("欢迎使用基于YOLO11及改进的红外空中目标识别系统\n")
